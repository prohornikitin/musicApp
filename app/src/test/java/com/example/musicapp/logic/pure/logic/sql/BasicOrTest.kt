...
import com.example.musicapp.domain.logic.pure.sql.Basic.or
import com.example.musicapp.domain.logic.pure.sql.Basic.orMany
...
class BasicOrTest {
    ...
    @Test
    fun orMany_common() {
        assertCharSeqEquals("(A OR B OR C)", orMany(listOf(
            "A",
            "B",
            "C",
        )))
    ...
    fun orMany_firstIsEmpty() {
        assertCharSeqEquals("(B OR C)", orMany(listOf(
            "",
            "B",
            "C",
        )))
    ...
    fun orMany_midIsEmpty() {
        assertCharSeqEquals("(A OR C)", orMany(listOf(
            "A",
            "",
            "C",
        )))
    ...
    fun orMany_lastIsEmpty() {
        assertCharSeqEquals("(A OR B)", orMany(listOf(
            "A",
            "B",
            "",
        )))
    ...
    fun orMany_allAreEmpty() {
        assertCharSeqEquals("", orMany(listOf(
            "",
            "",
            "",
        )))
